...
<body class="">
    ...
    <div class="d-flex justify-content-around align-items-center fixed-bottom bg-light pt-2 px-2">
        <div class="d-flex flex-column align-items-center justify-content-center action-items">
            <a href="home.php"><img src="assets/icons/home.svg" width="16" alt="" /></a>
        ...
        <div class="d-flex flex-column align-items-center justify-content-center action-items">
    <a href="#" id="myButton"><img src="assets/img/logo-without-text.png" width="64" alt="" /></a>
</div>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
        <script>
            ...
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    title: 'Masroufi',
                    text: 'il vous reste ' + <?php echo $daily_expense; ?> + ' dt a depenser aujourdhui',
                    icon: 'info',
